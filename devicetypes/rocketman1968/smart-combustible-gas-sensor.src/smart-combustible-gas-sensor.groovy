/**
 *  Zipato HM-HS1CG-M.US Zigbee Smart Combustible Gas Sensor
 *
...
metadata {
	definition (name: "Smart Combustible Gas Sensor", namespace: "rocketman1968", author: "rocketman1968") {
	...
	tiles(scale:2) {
		multiAttributeTile(name:"smoke", type: "generic", width: 6, height: 4) {
			tileAttribute ("device.smoke", key: "PRIMARY_CONTROL") {
           		attributeState("clear", label:'clear', icon:"st.Weather.weather14", backgroundColor:"#ffffff")
            	attributeState("detected", label:'GAS', icon:"st.Weather.weather8", backgroundColor:"#e86d13")   
 			}
