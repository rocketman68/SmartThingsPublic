...
def zwaveEvent(physicalgraph.zwave.commands.switchbinaryv1.SwitchBinaryReport
cmd, endpoint) {
...
encap(zwave.basicV1.basicGet(), 2) // further gets are sent from thebasic report handler
],200)
}
